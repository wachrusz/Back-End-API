...
COPY public.sessions (session_id, username, device_id, created_at, last_activity, user_id) FROM stdin;
60	newuser	::1_curl/8.4.0	2023-12-06 00:05:09.417704+03	2023-12-06 00:05:09.417704+03	6
\.
...
6	newuser	$2a$10$QEeLTLxWTwbAxlYH6kEaTe66I7pZU3oMegufaRJmgYXqleQ3g22o2	misha
...
SELECT pg_catalog.setval('public.income_categories_id_seq', 1, true);
...
SELECT pg_catalog.setval('public.income_id_seq', 4, true);
...
SELECT pg_catalog.setval('public.sessions_session_id_seq', 60, true);
