...
ALTER TABLE public.expense DROP COLUMN IF EXISTS type CASCADE, DROP COLUMN IF EXISTS is_liquid CASCADE;
ALTER TABLE public.income DROP COLUMN IF EXISTS type CASCADE, DROP COLUMN IF EXISTS is_liquid CASCADE;
